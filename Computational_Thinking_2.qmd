...
new_bisonF1 <- new_bisonF %>% # naming output of this code 
  ...
  mutate(bison_fertility = case_when(
    ...
    # bison > 9 years will be recorded as "Older Reduced Fertility"
    ...
    # bison between 2 and 9 years old will be recorded as "Older Reduced Fertility"
    .default = "Unknown Age" # any age that is not listed will be inpute as "Unknown age".
  ))
